package org.succlz123.spi.plugin
...
class SpiGradlePlugin extends Transform implements Plugin<Project> {
    ...
    void transform(Context context, Collection<TransformInput> inputs, Collection<TransformInput> referencedInputs,
        ...
        println '--- SpiGradlePlugin transform start ---'
        ...
        println '--- SpiGradlePlugin transform end - cost ' + cost + 's ---'
    }
    ...
    static void handleManagerJarInputs(JarInput jarInput, List<ClassParameter> processClasses, TransformOutputProvider outputProvider) {
        ...
        for (String className : classNameList) {
            if (className == ("org.succlz123.spi.SpiManager.class")) {
    ...
    private static boolean isMapperClass(String name) {
        return name.contains("SpiMapper")
    }

    private static boolean isManagerClass(String name) {
        return name.contains("SpiManager.class")
    }
}
